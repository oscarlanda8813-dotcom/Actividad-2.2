...
namespace DirectorioONG.Models
{
    public class Donacion
    {
        ...
        {
            get { return folio; }
            set { if (string.IsNullOrWhiteSpace(value)) throw new ArgumentException("Folio requerido."); folio = value; }
        }
        ...
        public DateTime FechaDonacion
        {
            ...
            set { if (value > DateTime.Now) throw new ArgumentException("La fecha no puede ser futura."); fechaDonacion = value; }
        }
